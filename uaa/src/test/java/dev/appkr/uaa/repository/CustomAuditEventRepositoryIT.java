...
import dev.appkr.uaa.config.audit.AuditEventConverter;
import dev.appkr.uaa.domain.PersistentAuditEvent;
...
import static dev.appkr.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
